...
if(firstAnswer === 'left') { 
    ...
    if(secondAnswer === 'follow') {     
        ...
        ('Do you head You follow the cat to a colony of cats, nestled in a fort of warm blankets and subsisting off of inexplicably warm soup. They are content with you staying, but you wonder if you should alert the world to this magical safe haven. or right?') 
}
